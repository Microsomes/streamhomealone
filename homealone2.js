...
const ffmpeg = child_process.spawn('ffmpeg', [
    ...
    '-nostdin',
    '-i',
    'https://maeplet.fra1.digitaloceanspaces.com/homealone/Home.Alone.2.Lost.in.New.York.1992.720p.BluRay.x264.YIFY.mp4',
    '-vcodec',
    'libx264',
    '-preset:v',
    'ultrafast',
    ...
    '-f',
    'flv',
    'rtmp://talkfssteam.com:1936/live/homealone2'
]);
